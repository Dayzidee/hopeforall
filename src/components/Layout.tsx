      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <span className="font-montserrat font-bold text-2xl text-white-text">Vessel</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {!user && (
              <>
                <Link to="/#mission" className="text-white-text font-montserrat font-bold hover:text-accent-teal transition-colors">Mission</Link>
        ...
        {isOpen && (
          <div className="md:hidden mt-4 pb-4 flex flex-col space-y-4">
            ...
            {!user && <Link to="/login" className="text-white-text font-montserrat font-bold" onClick={() => setIsOpen(false)}>Login</Link>}
            {user ? (
              <>
...
export const PublicLayout = () => {
  return (
    <div className="min-h-screen flex flex-col font-lato">
      ...
      <footer className="p-4 bg-dark-text text-white-text text-center">
        © 2025 Vessel Church. All rights reserved.
      </footer>
    </div>
  );
};
